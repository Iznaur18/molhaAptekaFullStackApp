...
/**
 * Валидация query-параметров для GET /product и GET /product/my
 * (поиск: название, productSearchBlob, синонимы категорий).
 */
export const productsSearchValidation = [
  ...
  query("sort")
    ...
    .withMessage("sort должен быть newest, views, purchases, premium или confirmed"),
  query("includeHidden")
    .optional()
    .isIn(["true", "false"])
