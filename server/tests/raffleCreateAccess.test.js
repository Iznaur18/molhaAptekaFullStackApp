...
test("hasRaffleCreateUnlock detects paid access", () => {
  ...
  assert.equal(hasRaffleCreateUnlock({ raffleCreateUnlockAt: "2026-01-01T00:00:00.000Z" }), false);
  assert.equal(
    hasRaffleCreateUnlock({ raffleCreateUnlockAt: new Date("2026-01-01T00:00:00.000Z") }),
    true,
  );
});
