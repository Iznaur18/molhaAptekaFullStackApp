...
export const PRODUCT_PROMOTION_TIER_META = [
  {
    ...
    title: "Золото",
    description:
      "Золотой значок «Буст» на карточке. В регионе продажи товар поднимается выше обычных объявлений. В других регионах — только значок, без поднятия.",
  },
  {
    tier: PRODUCT_PROMOTION_TIER_TOP,
    title: "ТОП",
    description:
      "Фиолетовый значок. В ленте «Сначала новые» уходит в самый верх у всех покупателей, в любом регионе. В поиске тоже выше обычных товаров. Несколько ТОП — выше тот, кто включил рекламу позже.",
  },
  {
    tier: PRODUCT_PROMOTION_TIER_BANNER,
    title: "Баннер",
    description:
      "Как Буст по поднятию в регионе продажи, плюс широкая карточка на всю строку в главной ленте. В других регионах значок остаётся, но без поднятия в выдаче.",
  },
];
