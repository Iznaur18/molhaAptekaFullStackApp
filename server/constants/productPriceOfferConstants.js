...
export const IN_APP_NOTIFICATION_KIND_PRICE_OFFER_ACCEPTED = "price_offer_accepted";
export const IN_APP_NOTIFICATION_KIND_PRICE_OFFER_REJECTED = "price_offer_rejected";
export const IN_APP_NOTIFICATION_KIND_PRICE_OFFER_OUTBID_WON = "price_offer_outbid_won";
