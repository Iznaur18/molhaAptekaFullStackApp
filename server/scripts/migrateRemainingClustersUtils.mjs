...
const CLUSTERS = {
  "seller-personal-category": [
    "sellerPersonalCategoryHelpers.js",
    "validateSellerPersonalCategoryImageUrl.js",
    "cleanupReplacedSellerPersonalCategoryImage.js",
  ],
  auth: ["emailVerification.js", "assertEmailVerified.js"],
  access: ["adminUserGuard.js", "premiumStaffAccess.js"],
};

const EXISTING_SERVICE_DIRS = [
  "user",
  "product",
  "order",
  "installment",
...
const walkAndUpdateImports = (dir) => {
  for (const entry of fs.readdirSync(dir, { withFileTypes: true })) {
    ...
    if (
      entry.name === "migrateRemainingClustersUtils.mjs" ||
      entry.name === "migrateNextClustersUtils.mjs"
    ) {
      continue;
    }
...
console.log(
  `Migrated ${migratedCount} utils → seller-personal-category/auth/access; imports updated`,
);
