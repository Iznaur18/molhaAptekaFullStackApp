...
const REVIEW_TEMPLATES = [
  {
    rating: 5,
    text: "Отличный товар, всё как в описании. Доставка быстрая, упаковка аккуратная.",
  },
  {
    rating: 5,
    text: "Беру уже не первый раз — качество стабильно хорошее. Рекомендую.",
  },
  {
    rating: 4,
    text: "В целом доволен. Небольшие нюансы по комплектации, но на оценку почти не влияют.",
  },
  { rating: 5, text: "Супер! Соответствует фото, без сюрпризов. Буду заказывать ещё." },
  {
    rating: 4,
    text: "Хорошее соотношение цена/качество. Пришло вовремя, товар рабочий.",
  },
  {
    rating: 5,
    text: "Очень довольна покупкой. Упаковали надёжно, товар без повреждений.",
  },
