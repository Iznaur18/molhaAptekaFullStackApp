...
const CATEGORY_TREE_FILES = [
  "backfillProductCategoryIds.js",
  "computeProductCategoryNodePaths.js",
  "ensureProductCategoryDisplayForSlug.js",
  "normalizeProductCategorySearchKeywords.js",
  "productCategoryDeleteHelpers.js",
  "rebuildProductCategorySubtreePaths.js",
  "seedProductCategoryTree.js",
  "syncProductsDenormForCategorySubtree.js",
  "toProductCategoryPublicPayload.js",
];

const MOVED_FILES = [...new Set([...EXISTING_PRODUCT_FILES, ...CATEGORY_TREE_FILES])];
...
for (const fileName of CATEGORY_TREE_FILES) {
