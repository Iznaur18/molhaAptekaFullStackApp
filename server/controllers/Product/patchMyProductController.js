...
import { notifySellerAuctionToggledByAdmin } from "../../utils/productAuction.js";
import {
...
export const patchMyProductController = async (req, res) => {
  try {
    ...
    if (!existing) {
      return errorRes(res, 404, "Товар не найден или нет прав на изменение");
    }
    ...
    if (Object.prototype.hasOwnProperty.call(body, "productCharacteristics")) {
      try {
    ...
    if (
      ...
      try {
        const nextPrice = Object.prototype.hasOwnProperty.call($set, "productPrice")
          ? $set.productPrice
    ...
    if (
      Object.prototype.hasOwnProperty.call(body, "productCategoryId") ||
      Object.prototype.hasOwnProperty.call(body, "productCategory")
    ) {
      try {
    ...
    } else if (Object.prototype.hasOwnProperty.call($set, "productImageUrls")) {
    ...
    if (!isAdmin) {
      const pendingAuctionOnly =
        ...
        Object.prototype.hasOwnProperty.call(body, "productAuctionEnabled") &&
        !touchesContent &&
