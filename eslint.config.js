...
const sharedIgnores = [
  ...
  "**/.cursor/**",
  "**/.expo/**",
  // Служебные копии репозитория, которые агенты создают внутри проекта, и
  // локальные выгрузки Expo. В CI их нет, а локально они давали тысячи
  // фантомных ошибок и прятали настоящие.
  "**/.claude/**",
