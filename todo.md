...
4. Майл пароль
5. Переделать веб сайт проекта на такой же вид и работу так как мобильное приложение 
7. Когда юзер покупает товар в рассрочку, должно появится модальное окно, которое спросит о разрешении отправки паспортных данных продавцу товара, и только при согласии он сможет продолжить покупку, а продавец получит паспортные данные от покупателя в заявке на покупку товара где уже есть кнопка принять или откланить
8. Улучшить и сделать красивее внешний вид раздела "Управлени" в моих товара, на обеих разделах в клауд
