...
4. Майл пароль
5. Переделать веб сайт проекта на такой же вид и работу так как мобильное приложени
6. [x] Добавить раздел соцсети для профиля юзера, в этом разделе юзеры смогут указать соцсеть и вставить туда ссылку своего профиля, а при клике другим юзером на эту ссылку он будет переходить по ссылке 
