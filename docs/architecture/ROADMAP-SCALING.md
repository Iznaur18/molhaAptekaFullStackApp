...
| [`release-smoke-matrix.md`](../quality/release-smoke-matrix.md) | матрица smoke по зонам |
...
- [ ] [`release-smoke-matrix.md`](../quality/release-smoke-matrix.md) перед релизом
...
- [`LOCAL-DEV-SETUP.md`](../start/LOCAL-DEV-SETUP.md)
