...
> **152-ФЗ.** В логах есть IP-адреса пользователей. Grafana Cloud хранит их за границей — это трансграничная передача, её нужно указывать в уведомлении Роскомнадзора. Для прода Gitorg берите вариант B на своём сервере в РФ или C.

| Вариант | Когда |
| ------- | ----- |
| **A. Grafana Alloy → Grafana Cloud Loki** | быстрый старт, без своего Loki; данные за границей |
