...
- [x] Перенос roadmap в `docs/clients/mobile-development.md`
...
- [x] Скриншоты, описание, keywords RU/EN — `store-assets/`, `mobile/mobile/docs/STORE-SCREENSHOTS.md`, `npm run capture:store-screenshots`
...
| WF-7.2 | Регрессионный чеклист по матрице | `docs/clients/mobile-development.md` § WF-7.2 | ✅ |
...
WF + WS закрыты. Дальше по `docs/clients/mobile-development.md`:
