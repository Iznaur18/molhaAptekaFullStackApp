...
import { WHOLESALE_PRICE_SHEET_ANIMATION } from "@/entities/product/lib/wholesalePriceSheetAnimation";
...
export const useWholesalePriceSheetAnimation = (
  visible: boolean,
  sheetSlideDistance: number,
): WholesalePriceSheetAnimation => {
