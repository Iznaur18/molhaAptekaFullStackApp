...
export const INSTALLMENT_CONTRACT_STATUS_FILTER_OPTIONS = [
  { value: "", labelKey: "CONTRACT_STATUS_FILTER_ALL" as const },
  {
    ...
    labelKey: "CONTRACT_STATUS_FILTER_IN_PROGRESS" as const,
  },
  {
    value: INSTALLMENT_CONTRACT_STATUS_COMPLETED,
    labelKey: "CONTRACT_STATUS_FILTER_COMPLETED" as const,
  },
  {
    value: INSTALLMENT_CONTRACT_STATUS_DEFAULTED,
    labelKey: "CONTRACT_STATUS_FILTER_DEFAULTED" as const,
  },
  {
    value: INSTALLMENT_CONTRACT_STATUS_CANCELLED,
    labelKey: "CONTRACT_STATUS_FILTER_CANCELLED" as const,
  },
];
