...
export const API_CLIENT_UI = {
  ...
  FETCH_ADDRESS_GEOLOCATE_FALLBACK: "Не удалось определить адрес по карте",
...
export const EDIT_PROFILE_UI = {
  ...
  PHONE_VERIFY_SEND_LOADING: "Отправка…",
  PHONE_VERIFY_CODE_LABEL: "Код из SMS",
  PHONE_VERIFY_CODE_PLACEHOLDER: "000000",
  PHONE_VERIFY_CONFIRM: "Подтвердить телефон",
  PHONE_VERIFY_SENT: "Код отправлен по SMS",
  PHONE_VERIFY_SUCCESS: "Телефон подтверждён",
  PHONE_VERIFY_ERROR: "Не удалось подтвердить телефон",
  PHONE_VERIFY_REQUEST_ERROR: "Не удалось отправить SMS",
  PHONE_VERIFY_CODE_REQUIRED: "Введите 6-значный код из SMS",
  ...
  EMAIL_VERIFY_SEND: "Получить код на email",
  EMAIL_VERIFY_SEND_LOADING: "Отправка…",
  EMAIL_VERIFY_CODE_LABEL: "Код из письма",
  EMAIL_VERIFY_CODE_PLACEHOLDER: "000000",
  EMAIL_VERIFY_CONFIRM: "Подтвердить email",
  EMAIL_VERIFY_SENT: "Код отправлен на email",
  EMAIL_VERIFY_SUCCESS: "Email подтверждён",
...
/** Горящая скидка — временная скидка продавца с обратным отсчётом */
export const PRODUCT_FLASH_SALE_UI = {
  ...
  MANAGE_HINT_AUCTION_BLOCKED: " (отключите аукцион)",
  MANAGE_HINT_MANUAL_DISCOUNT_BLOCKED: " (уберите ручную скидку)",
  ...
  CATALOG_BADGE: (discountPercent: unknown): string => {
...
export const PRODUCT_PROMO_CODE_UI = {
  ...
  APPLIED_PERCENT: (percent: number) => `−${percent}%`,
...
export const PRODUCT_PROMOTION_UI = {
  ...
  DURATION_LABEL: "Срок",
  DURATION_PRICE_RUB: (amountRub: number) => `${amountRub} руб.`,
  SUMMARY_TIER: "Уровень",
  SUMMARY_DURATION: "Срок действия",
  TOTAL_LABEL: "К оплате",
  TOTAL_RUB: (amountRub: number) => `${amountRub} руб.`,
...
export const PRODUCT_QA_UI = {
  ...
  TAB_WITH_COUNT: (count: number) => `Вопросы и ответы (${count})`,
  ...
  ANSWER_FALLBACK: "Не удалось отправить ответ",
  DELETE_FALLBACK: "Не удалось удалить вопрос",
  HIDE_FALLBACK: "Не удалось скрыть вопрос",
} as const;
...
export const HOME_FEED_UI = {
  ...
  CURATED_CATEGORIES_SECTION_ARIA: "Подборки категорий",
...
export const PRODUCT_PICKUP_UI = {
  ...
  ERROR_ADDRESS_NOT_ADDED:
    "Адрес в поле не добавлен в точки — нажмите «Добавить точку» или очистите поле",
  ...
  LOCATIONS_MAX: (max: number) => `Не больше ${max} точек самовывоза`,
...
export const AUTH_UI = {
  ...
  PHONE_LABEL: "Телефон",
  PHONE_PLACEHOLDER: "8 (912) 345-67-89",
  ...
  LOGIN_CODE_LABEL: "Код из SMS",
  LOGIN_CODE_PLACEHOLDER: "000000",
  LOGIN_CODE_LENGTH: 6,
  LOGIN_ERROR_PHONE_REQUIRED: "Укажите номер телефона",
  LOGIN_ERROR_CODE_REQUIRED: "Введите 6-значный код из SMS",
  ...
  REGISTER_CODE_TITLE_PHONE: "Подтвердите телефон",
  ...
  FORGOT_SEND_ERROR: "Не удалось отправить код",
  ...
  FORGOT_CONFIRM_ERROR: "Не удалось сбросить пароль",
...
export const SELLER_SHELF_UI = {
  ...
  SAVE_NAME: "Сохранить",
  CANCEL_RENAME: "Отмена",
  NAME_TOO_LONG: (max: number) => `Максимум ${max} символов`,
  ASSIGN: "Товары",
  DELETE: "Удалить",
...
export const CREATE_PRODUCT_UI = {
  ...
  MANAGE_PROMO_CODES_HINT: "Коды со скидкой для покупателей этого товара",
  MANAGE_PROMO_CODES_PENDING: "Обновление…",
...
export const PRODUCT_MODERATION_PAGE_UI = {
  ...
  ORIGIN_LABEL: "Точка отправления",
  COORDS_LABEL: "Координаты",
  COORDS_EMPTY: "Не указаны",
  COORDS_VALUE: (lat: number, lon: number) => `${lat}, ${lon}`,
...
export const POPULAR_CATEGORIES_ADMIN_PAGE_UI = {
  ...
  CATEGORY_PICK_TREE: "Выбрать категорию из дерева",
  CATEGORY_PICK_PERSONAL: "Выбрать личную категорию",
  ...
  PERSONAL_CATEGORY_SHEET_TITLE: "Личные категории",
  PERSONAL_CATEGORY_SHEET_CLOSE: "Закрыть",
  ...
  MOVE_UP_ARIA: "Поднять список",
  MOVE_DOWN_ARIA: "Опустить список",
  ITEM_KIND_TREE: "Дерево",
  ITEM_KIND_PERSONAL: "Личная",
