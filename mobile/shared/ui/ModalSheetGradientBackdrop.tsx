    ...
    <Svg width="100%" height="100%" preserveAspectRatio="none">
      <Defs>
        <LinearGradient id={MODAL_SHEET_BACKDROP_GRADIENT_ID} x1="0" y1="0" x2="0" y2="1">
          <Stop offset="0" stopColor={semanticColors.ink} stopOpacity="0" />
          <Stop offset="0.38" stopColor={semanticColors.ink} stopOpacity="0.1" />
          <Stop offset="0.68" stopColor={semanticColors.ink} stopOpacity="0.28" />
          <Stop offset="1" stopColor={semanticColors.ink} stopOpacity="0.52" />
        </LinearGradient>
      </Defs>
