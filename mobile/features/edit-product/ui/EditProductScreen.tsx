...
export const EditProductScreen = ({ productId }: EditProductScreenProps) => {
  ...
  const [productListingOrigin, setProductListingOrigin] =
    useState<ProductListingOrigin | null>(null);
  ...
  useEffect(() => {
    ...
    setProductListingOrigin(
      isProductListingOrigin(product.productListingOrigin)
    ...
    const regionRaw =
      typeof product.productRegionCode === "string"
        ...
        : "";
    setProductRegionCode(
      isRuRegionCode(regionRaw) ? regionRaw : DEFAULT_VIEWER_REGION_CODE,
    );
    ...
    setCharacteristicRows(
      mapProductCharacteristicsToRows(product.productCharacteristics),
    );
  ...
  const runDelete = async () => {
    ...
    try {
      ...
      setErrorMessage(
        error instanceof Error ? error.message : CREATE_PRODUCT_UI.DELETE,
      );
    }
  };
        ...
        <View style={styles.content}>
          <View style={[styles.zoneBlock, styles.zoneMain]}>
            ...
            {discountPercent != null ? (
              ...
              >
                <Text
                  style={[styles.discountPreviewText, { color: theme.colors.success }]}
                >
            ...
            <ProductPickupLocationFields
              ...
              selectedFromSuggest={
                Boolean(productPickupAddress.trim()) &&
          ...
          {errorMessage ? (
            <View
              style={[styles.feedbackBox, styles.errorBox]}
