...
export const MySalesPageOverview = ({
  inProgressCount,
  attentionCount,
  totalAmountRub,
  attentionOnly,
  ...
  return (
    <View style={styles.overview} accessibilityRole="summary">
      ...
      >
        <Text style={styles.overviewLabel}>{MY_SALES_PAGE_UI.OVERVIEW_ATTENTION}</Text>
        <Text
          style={[
      ...
      <View style={[styles.overviewTile, styles.overviewTileStatic]}>
        <Text style={styles.overviewLabel}>{MY_SALES_PAGE_UI.OVERVIEW_TOTAL}</Text>
