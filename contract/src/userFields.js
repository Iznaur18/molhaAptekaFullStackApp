...
/**
 * Длина адресной строки — одна на всё приложение.
 *
 * Ровно 100 символов не хватает: DaData отдаёт настоящие адреса длиннее.
 * «Ханты-Мансийский Автономный округ - Югра, Кондинский р-н, пгт
 * Междуреченский, ул Волгоградская, уч 12а» — 102 символа, и таких вариантов
 * в одной выдаче сразу три. Покупатель выбирал подсказку, а сервер отвечал
 * «Адрес не длиннее 100 символов» — заказать было нельзя вовсе.
 *
 * 200 берём с запасом на худший реальный случай: длинное название округа плюс
 * район, плюс населённый пункт, плюс улица имени Героя Советского Союза с
 * фамилией, плюс дом с корпусом.
 *
 * Значение живёт здесь и только здесь. Раньше эта же сотня была прописана в
 * шести местах — контракт, сервер, веб, мобилка, — и разъехаться им ничто не
 * мешало: zod пропускал бы то, что отвергает mongoose, и пользователь получал
