...
import { contractNeedsBuyerAttention } from "../../../entities/installment/lib/contractNeedsBuyerAttention.js";
import { filterInstallmentBuyerContracts } from "../../../entities/installment/lib/filterInstallmentBuyerContracts.js";
import { summarizeInstallmentBuyerContracts } from "../../../entities/installment/lib/summarizeInstallmentBuyerContracts.js";
  ...
  useEffect(() => {
    setExpandedIds((prev) => {
      ...
      for (const contract of allContracts) {
        if (contractNeedsBuyerAttention(contract)) {
