...
const ADMIN_TABS = [
  ...
  {
    id: SITE_HEADER_BANNER_ADMIN_TAB_BADGES,
    label: SITE_HEADER_BANNER_ADMIN_PAGE_UI.TAB_BADGES,
  },
];
...
export function SiteHeaderBannerAdminPage() {
  ...
  const handleRemoveSlide = (itemId) => {
    ...
    setForm((prev) => {
      ...
      setSelectedSlideId((currentId) =>
        resolveNextSelectedSlideId(nextItems, itemId, currentId),
      );
  ...
  if (settingsQuery.isPending) {
    return (
      <p className="site-header-banner-admin__status">
        {SITE_HEADER_BANNER_ADMIN_PAGE_UI.LOADING}
      </p>
    );
  }
  ...
  return (
    <section className="site-header-banner-admin">
      <header className="site-header-banner-admin__header">
        ...
        <p className="site-header-banner-admin__hint">
          {SITE_HEADER_BANNER_ADMIN_PAGE_UI.HINT}
        </p>
        <ModalSectionTabs
      ...
      activeTab === SITE_HEADER_BANNER_ADMIN_TAB_GUEST ? (
        <form className="site-header-banner-admin__form" onSubmit={handleSave}>
          ...
          {actionError ? (
            <p
              className="site-header-banner-admin__panel site-header-banner-admin__panel-section site-header-banner-admin__error"
              role="alert"
            >
              {actionError}
            </p>
