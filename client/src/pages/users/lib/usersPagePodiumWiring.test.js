    ...
    const users = [
      {
        ...
        totalSalesCount: 1,
        userRatingByVotes: { countVotes: 1, totalRating: 5 },
        followersCount: 1,
      },
      {
        _id: "b",
        userLoyaltyPoints: 30,
        totalSalesCount: 2,
        userRatingByVotes: { countVotes: 2, totalRating: 8 },
        followersCount: 2,
      },
      {
        _id: "c",
        userLoyaltyPoints: 20,
        totalSalesCount: 3,
        userRatingByVotes: { countVotes: 1, totalRating: 4 },
        followersCount: 3,
      },
      {
        _id: "d",
