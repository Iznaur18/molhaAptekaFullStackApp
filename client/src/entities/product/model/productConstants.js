...
/** Фильтр списка в «Мои товары» (query `moderationStatus`). */
export const MY_PRODUCTS_MODERATION_FILTER_ALL = "";
export const MY_PRODUCTS_MODERATION_FILTER_PENDING = "pending";
export const MY_PRODUCTS_MODERATION_FILTER_APPROVED = "approved";
export const MY_PRODUCTS_MODERATION_FILTER_REJECTED = "rejected";
export const MY_PRODUCTS_MODERATION_FILTER_HIDDEN = "hidden";
export const MY_PRODUCTS_MODERATION_FILTER_PROMOTED = "promoted";
export const MY_PRODUCTS_MODERATION_FILTER_NOT_PROMOTED = "not_promoted";

export const MY_PRODUCTS_MODERATION_FILTER_OPTIONS = [
  MY_PRODUCTS_MODERATION_FILTER_ALL,
  MY_PRODUCTS_MODERATION_FILTER_PENDING,
  MY_PRODUCTS_MODERATION_FILTER_APPROVED,
  MY_PRODUCTS_MODERATION_FILTER_REJECTED,
  MY_PRODUCTS_MODERATION_FILTER_HIDDEN,
  MY_PRODUCTS_MODERATION_FILTER_PROMOTED,
  MY_PRODUCTS_MODERATION_FILTER_NOT_PROMOTED,
];
...
export const MY_PRODUCTS_MODERATION_FILTER_LABEL_RU = {
  ...
  [MY_PRODUCTS_MODERATION_FILTER_APPROVED]: "Одобрены",
  [MY_PRODUCTS_MODERATION_FILTER_REJECTED]: "Отклонены",
  [MY_PRODUCTS_MODERATION_FILTER_HIDDEN]: "Скрыты от покупателей",
  [MY_PRODUCTS_MODERATION_FILTER_PROMOTED]: "С продвижением",
  [MY_PRODUCTS_MODERATION_FILTER_NOT_PROMOTED]: "Без продвижения",
};
