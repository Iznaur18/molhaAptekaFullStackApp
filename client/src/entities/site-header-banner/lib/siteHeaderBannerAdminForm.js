 ...
 */
export const mapSiteHeaderBannerSettingsToForm = (settings) => {
...
/**
 * @param {ReturnType<typeof mapSiteHeaderBannerSettingsToForm>} form
 */
 ...
 * @returns {string | null}
 */
export const validateSiteHeaderBannerAdminForm = (form) => {
