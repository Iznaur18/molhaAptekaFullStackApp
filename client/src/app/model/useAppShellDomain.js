...
export function useAppShellDomain(
  ...
  const curatedProductListsState = useHomeCuratedProductLists({
    ...
    catalogBuyNFreeOnly: catalogLoader.catalogBuyNFreeOnly,
  ...
  const productActions = useHomeProductActions({
    ...
    setTogglingOutOfStockProductId: shell.setTogglingOutOfStockProductId,
    setTogglingWholesaleProductId: shell.setTogglingWholesaleProductId,
    setTogglingBuyNFreeProductId: shell.setTogglingBuyNFreeProductId,
    ...
    setTogglingLoyaltyProductId: shell.setTogglingLoyaltyProductId,
