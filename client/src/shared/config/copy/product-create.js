...
export const SELLER_PRODUCTS_LIMIT_MODAL_UI = {
  ...
  /** Персональный лимит от админа (или иной нестандартный порог). */
  BODY_PERSONAL: (limit) =>
    `Достигнут лимит товаров: ${limit}. Чтобы разместить новый, удалите один из существующих или напишите в поддержку.`,
  CLOSE: "Понятно",
...
export const CREATE_PRODUCT_MODAL_UI = {
  ...
  BULK_IMPORT_OPEN: "Импорт из Excel",
  BULK_IMPORT_TITLE: "Импорт товаров из Excel",
  BULK_IMPORT_HINT:
    "Скачайте шаблон, заполните строки и загрузите файл. В колонке «категория» скопируйте путь с листа «Категории» (можно через > или ›). Нужна конечная подкатегория, не корень. Адрес самовывоза — из профиля.",
  BULK_IMPORT_DOWNLOAD_TEMPLATE: "Скачать шаблон",
  BULK_IMPORT_PICK_FILE: "Выбрать файл .xlsx",
  BULK_IMPORT_SUBMIT: "Загрузить и импортировать",
  BULK_IMPORT_SUBMIT_LOADING: "Проверяем файл…",
  BULK_IMPORT_PROGRESS: (processed, total) => `Обработано ${processed} / ${total}`,
  BULK_IMPORT_COMPLETED: (count) =>
    `${count} товар(ов) создано и отправлено на модерацию`,
  BULK_IMPORT_FAILED: "Импорт не завершён",
  BULK_IMPORT_CLOSE: "Закрыть",
  BULK_IMPORT_VALIDATION_TITLE: "Исправьте ошибки в файле",
  BULK_IMPORT_ERROR_GENERIC: "Не удалось импортировать товары",
  BULK_IMPORT_FILE_ARIA: "Выбрать Excel-файл с товарами",
