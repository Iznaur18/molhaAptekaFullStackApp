...
export const HOME_PAGE_UI = {
  ...
  CATALOG_FILTERS_SHEET_CLOSE: "Закрыть",
  CATALOG_FILTERS_SHEET_RESET: "Сбросить",
  CATALOG_FILTERS_SHEET_SORT: "Сортировка",
  CATALOG_FILTERS_SHEET_RANKING_RULES: "Как формируется выдача",
  CATALOG_FILTERS_SHEET_PRICE: "Цена, ₽",
  CATALOG_FILTERS_SHEET_PRICE_FROM: "от",
  CATALOG_FILTERS_SHEET_PRICE_TO: "до",
  CATALOG_FILTERS_SHEET_PRICE_FROM_ARIA: "Цена от, рублей",
  CATALOG_FILTERS_SHEET_PRICE_TO_ARIA: "Цена до, рублей",
  /** @param {string} price */
  CATALOG_FILTERS_SHEET_PRICE_UP_TO: (price) => `до ${price}`,
  CATALOG_FILTERS_SHEET_DELIVERY: "Получение",
  CATALOG_FILTERS_SHEET_RATING: "Рейтинг",
  CATALOG_FILTERS_SHEET_BENEFIT: "Выгода",
  CATALOG_FILTERS_SHEET_SELLER: "Продавец",
  CATALOG_FILTERS_SHEET_MORE: "Ещё",
  CATALOG_FILTERS_SHEET_SHOW: "Показать",
  /** Формы для `pluralizeRu`: «Показать 1 товар / 2 товара / 5 товаров». */
  CATALOG_FILTERS_SHEET_PRODUCT_FORMS: /** @type {const} */ ([
    "товар",
    "товара",
    "товаров",
  ]),
  CATALOG_FILTERS_SHEET_SHOW_PENDING: "Показать товары",
  CATALOG_FILTERS_SHEET_NOTHING_FOUND: "Ничего не найдено",
  /** Подписи вариантов окна фильтров (ключ — параметр адреса или значение `sort`). */
  CATALOG_FILTERS_SHEET_OPTION: {
    newest: "Новинки",
    purchases: "Популярные",
    price_asc: "Дешевле",
    price_desc: "Дороже",
    rating: "По рейтингу",
    discount: "По скидке",
    deliverySeller: "Доставка продавца",
    deliveryCourier: "Курьеры Gitorg",
    deliveryCarrier: "Служба доставки",
    pickupOnly: "Самовывоз",
    near: "Рядом",
    ratingMin4: "Рейтинг 4 и выше",
    withReviews: "Только с отзывами",
    saleOnly: "Со скидкой",
    flashSaleOnly: "Горящие скидки",
    installmentOnly: "Рассрочка",
    wholesaleOnly: "Опт",
    buyNFreeOnly: "N+1 в подарок",
    sellerConfirmed: "Подтверждённые",
    sellerPremium: "Премиум",
    followingOnly: "Мои подписки",
    originalOnly: "Оригинал",
    returnOnly: "С возвратом",
    auctionOnly: "Аукцион",
    rentalOnly: "Аренда",
    affiliateOnly: "Партнёрская программа",
  },
