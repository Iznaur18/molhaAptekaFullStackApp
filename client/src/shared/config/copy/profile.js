...
export const USER_PROFILE_COPY = {
  LABELS: {
    ...
    sellerProductsLimitOverride: "Лимит товаров",
...
/** Несколько аккаунтов в одном браузере: список, переключение, добавление. */
export const ACCOUNT_SWITCHER_UI = {
  TITLE: "Аккаунты",
  LIST_ARIA: "Аккаунты на этом устройстве",
  ACTIVE_ARIA: "Текущий аккаунт",
  SWITCH_ARIA: (name) => `Переключиться на ${name}`,
  REQUIRES_LOGIN: "Нужно войти снова",
  REMOVE_ARIA: (name) => `Убрать ${name} с этого устройства`,
  REMOVE_YES: "Убрать с устройства",
  REMOVE_CANCEL: "Оставить",
  REMOVE_CONFIRM: (name) =>
    `Убрать ${name} с этого устройства? Из аккаунта на других устройствах вы не выйдете.`,
  ADD: "Добавить аккаунт",
  LIMIT_REACHED: (max) => `На одном устройстве — не больше ${max} аккаунтов`,
  LOGOUT_ALL: "Выйти из всех аккаунтов",
  LOGOUT_ALL_CONFIRM: "Выйти из всех аккаунтов на этом устройстве?",
  LOGOUT_ALL_YES: "Да, выйти из всех",
  LOGOUT_ALL_CANCEL: "Отмена",
  SWITCHING: "Переключаем…",
  ERROR_FALLBACK: "Не удалось переключить аккаунт",
  SAVED_TITLE: "Сохранённые аккаунты",
  ADD_MODE_TITLE: "Добавление аккаунта",
  ADD_MODE_HINT:
    "Войдите во второй аккаунт — первый останется на устройстве, переключаться можно в профиле.",
  ADD_MODE_CANCEL: "Отменить и вернуться",
};
