...
export const useHomeProfileNavigation = ({
  ...
  const handleShippingCarriersFromProfile = useCallback(() => {
    navigateFromProfileTab(PROFILE_TAB_SHIPPING_CARRIERS);
  }, [navigateFromProfileTab]);
  ...
  const handleSafeDealModerationFromProfile = useCallback(() => {
    navigateFromProfileTab(PROFILE_TAB_SAFE_DEAL_MODERATION);
  }, [navigateFromProfileTab]);
