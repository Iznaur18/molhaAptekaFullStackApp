...
export const useHomeCatalogLoader = ({
  ...
  const browser = useCatalogBrowserLanding({
    ...
    catalogRentalOnly: filters.catalogRentalOnly,
    catalogAffiliateOnly: filters.catalogAffiliateOnly,
    catalogWholesaleOnly: filters.catalogWholesaleOnly,
    catalogBuyNFreeOnly: filters.catalogBuyNFreeOnly,
  ...
  useCatalogQuerySync({
    ...
    catalogExtraFilters: filters.catalogExtraFilters,
    catalogQueryFromUrl: filters.catalogQueryFromUrl,
    setCatalogSort: filters.setCatalogSort,
    setCatalogExtraFilters: filters.setCatalogExtraFilters,
    ...
    setCatalogRentalOnly: filters.setCatalogRentalOnly,
    setCatalogAffiliateOnly: filters.setCatalogAffiliateOnly,
    setCatalogWholesaleOnly: filters.setCatalogWholesaleOnly,
    setCatalogBuyNFreeOnly: filters.setCatalogBuyNFreeOnly,
  ...
  return {
    ...
    handleCatalogRentalOnlyToggle: filters.handleCatalogRentalOnlyToggle,
    handleCatalogAffiliateOnlyToggle: filters.handleCatalogAffiliateOnlyToggle,
    handleCatalogWholesaleOnlyToggle: filters.handleCatalogWholesaleOnlyToggle,
    handleCatalogOriginalOnlyToggle: filters.handleCatalogOriginalOnlyToggle,
