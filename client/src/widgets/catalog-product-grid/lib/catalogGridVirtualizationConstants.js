 ...
 * Было 101: до порога все карточки лежат в DOM (на 72 — ~2200 узлов), и на
 * слабых телефонах лента тормозила ещё до включения виртуализации. С 50 она
 * включается на третьей странице (72 товара).
 */
export const CATALOG_VIRTUALIZATION_MIN_ITEM_COUNT = 50;
