...
export const PROFILE_SECTION_SAFE_DEAL_MODERATION = "safe-deal-moderation";
...
/** Сервисные страницы: свободные заказы, интеграции, доставка, безопасная сделка, курьер. */
export const PROFILE_SERVICES_SECTION_ORDER = [
  PROFILE_SECTION_COURIER_OVERVIEW,
  PROFILE_SECTION_ONEC_INTEGRATION,
  PROFILE_SECTION_DELIVERY_PAYMENT,
  PROFILE_SECTION_SAFE_DEAL,
