...
export const PROFILE_SECTION_WEB_PATH = {
  ...
  [PROFILE_SECTION_COURIER_MODERATION]: "/courier-moderation",
  [PROFILE_SECTION_SAFE_DEAL_MODERATION]: "/safe-deal-moderation",
  [PROFILE_SECTION_INSTALLMENT_DISPUTES]: "/installment-disputes",
  [PROFILE_SECTION_SHIPMENT_DISPUTES]: "/shipment-disputes",
  [PROFILE_SECTION_SHIPPING_CARRIERS]: "/shipping-carriers",
  ...
  [PROFILE_SECTION_SITE_HEADER_BANNER_ADMIN]: "/site-header-banner-admin",
